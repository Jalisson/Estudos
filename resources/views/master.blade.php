        ...
        <div class="container ">
            <div class="row">
                <div class="col-3 logo-menu">
                    <img src="{{asset('img/logo/logoB2.png')}}" alt="">
                </div>
                <div class="col-6">
                ...
                <div class="col-3">
                    <p class="registro_menu"> Login/Registro</p>
                </div>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-3 footer-config">
                <img src="{{asset('img/logo/nevcodLogo.png')}}" alt="">
            </div>
            <div class="col-3 footer-config">
                <ul>
                     <h3 class="title-footer">Ultilitarios</h3>
                    <a href="#">
                        <li>
            ...
            <div class="col-4 footer-config">
                <ul>
                    <h3 class="title-footer">Informações de contato</h3>
                    <a href="#">
                        <li>
        ...
        <div class="text-center endfooter">
            <p class="Desc">{{Date('Y')}} | Todos os direitos reservados</p>
        </div>
    </div>
</footer>
</body>
